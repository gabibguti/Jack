...
public class Provider {
	private GridBagConstraints cards_constraints = new GridBagConstraints();							// Cards Layout for Player Frame
	{
	...
	public static ArrayList<Frame> framesList = new ArrayList<Frame>();
	   ...
	   public void RequestNewCard (ArrayList<Card> hand, JPanel controlPanel, JFrame frame) 			// Provides new card for player or bank
	   {
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "Deck ended. Cannot request any more cards.");		// Show error message when deck is out of cards
			}
	   }
}
